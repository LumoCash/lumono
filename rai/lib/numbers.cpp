...
void rai::uint256_union::encode_account (std::string & destination_a) const
{
	...
	destination_a.append ("_umol"); // lumo_
...
bool rai::uint256_union::decode_account (std::string const & source_a)
{
	...
	if (!error)
	{
		auto xrb_prefix (source_a[0] == 'l' && source_a[1] == 'u' && source_a[2] == 'm' && (source_a[3] == '_' || source_a[3] == '-'));
		auto nano_prefix (source_a[0] == 'l' && source_a[1] == 'u' && source_a[2] == 'm' && source_a[3] == 'o' && (source_a[4] == '_' || source_a[4] == '-'));
